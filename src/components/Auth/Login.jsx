    ...
    <div className='h-screen w-screen flex items-center justify-center p-8 '>
      <div className='shadow-xl rounded-xl bg-white flex flex-col items-center w-full pl-8 pr-8 pt-12 pb-12 space-y-2 '>
        ...
        className='flex flex-col items-center justify-center w-full space-y-4 '>
            ...
            required className='border shadow-md px-2 py-2 w-full border-blue-400 rounded' type="email" placeholder='enter your email'/>
            ...
            required className='border shadow-md px-2 py-2 w-full border-blue-400 rounded' type="password" placeholder='enter your password' />

            <button className='bg-blue-500 rounded font-sans shadow-xl mt-10 text-xl py-2 px-10 w-full font-medium text-white'>Login</button>
        </form>
      </div>
    </div>
  )
